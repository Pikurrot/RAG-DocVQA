...
if __name__ == "__main__":
	...
	args = {
		...
		"dataset": "MP-DocVQA",
		"embed_model": "BGE-reranker", # BGE, VT5, BGE-M3, BGE-reranker
		...
		"add_sep_token": False,
		"batch_size": 16, # 50 Oracle / Concat / MajorPage / WeightMajorPage / AnyConfOracle, 32 MaxConf / AnyConf, 16 MaxConfPage / AnyConfPage
		"chunk_num": 10,
		"chunk_size": 60,
		"overlap": 10,
