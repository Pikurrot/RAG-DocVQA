...
if __name__ == "__main__":
	...
	# 	"add_sep_token": False,
	# 	"batch_size": 10, # 50 Oracle / Concat / MajorPage / WeightMajorPage / AnyConfOracle, 32 MaxConf / AnyConf, 16 MaxConfPage / AnyConfPage
	# 	"chunk_num": 20,
	# 	"chunk_size": 60,
	# 	"chunk_size_tol": 0.2,
	# 	"overlap": 10,
	...
	args = {
		...
		"model": "RAGPix2Struct",
		# "layout_model": "DIT",
		"dataset": "DUDE-Noise", # MP-DocVQA / Infographics / DUDE / SP-DocVQA
		"batch_size": 1,
		"layout_batch_size": 4,
	...
	extra_args = {
		...
		"save_name_append": "noise-pages-v2-pix2struct-dude-mix-norag",
		"val_size": 1.0,
		"log_wandb": False,
