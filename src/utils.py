...
def check_config(config: dict) -> bool:
	...
	elif model_name in ["hi-layoutlmv3, hilt5", "hi-lt5", "hivt5", "hi-vt5"] and page_retrieval in ["concat", "logits", "maxconf", "anyconf", "maxconfpage", "anyconfpage", "majorpage", "weightmajorpage"]:
	...
	elif page_retrieval in ["concat", "logits", "maxconf", "anyconf", "maxconfpage", "anyconfpage", "majorpage", "weightmajorpage"] and config.get("max_pages") is not None:
